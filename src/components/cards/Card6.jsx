...
const Card6 = ({nft}) => {
  ...
  className="flex items-center noise-bg h-full justify-center m-1 rounded-3xl relative overflow-hidden" 
      ...
      >
        ...
        <div className="ml-12 md:mt-[72px] font-dm absolute z-10 w-[312px] h-[484px] md:w-full md:ml-[20%]">
          <div className='flex mt-[3%] md:mt-1'>
          <div className='mr-8 md:mr-12'>
          <p className="text-white flex mt-8 text-2xl md:text-[42px] leading-[38.40px]">
          {nft?.purchased ? nft.purchased: 0}
          </p>
          ...
          <div>
          <p className="text-white flex mt-8 text-2xl md:text-[42px] leading-[38.40px]">
          {nft?.minted ? nft?.minted : 0}
          </p>
          <p className='text-fade'>Minted (Aped In)</p>
          </div>
          </div>
          <div className='mt-44 md:mt-32'>
          <p className='text-ash text-lg md:text-xl lg:text-2xl'>Looking at your digital collectible</p>
          <p className='text-ash text-lg md:text-xl lg:text-2xl'>journey  <span className='text-white'>in a glance</span></p>
        </div>
        </div>
